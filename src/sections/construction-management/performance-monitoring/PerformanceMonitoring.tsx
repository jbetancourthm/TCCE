        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-stretch md:justify-start md:gap-6">
          <div className="relative h-[16.5rem] flex-1 overflow-hidden rounded-3xl bg-neutral-200 md:h-[19rem]">
            ...
            <div className="absolute inset-x-0 bottom-7 px-6 text-center">
              <span className="text-lg font-semibold text-white/95 drop-shadow">Performance Monitoring</span>
            </div>
          </div>

          <div className="relative h-[16.5rem] flex-1 overflow-hidden rounded-3xl bg-neutral-200 md:h-[19rem]">
            <div className="absolute inset-0 bg-gradient-to-br from-[#0B2B6E]/60 via-neutral-900/40 to-[#E4611F]/20" />
            <div className="absolute inset-x-0 bottom-7 px-6 text-center">
              <span className="text-lg font-semibold text-white/95 drop-shadow">Project Analytics</span>
            </div>
          </div>
          ...
          <div className="relative h-[16.5rem] flex-1 overflow-hidden rounded-3xl bg-neutral-200 md:h-[19rem]">
            ...
            <div className="absolute inset-x-0 bottom-7 px-6 text-center">
              <span className="text-lg font-semibold text-white/95 drop-shadow">Quality Assurance</span>
            </div>
          </div>
        </div>
