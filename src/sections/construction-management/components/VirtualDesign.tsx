  ...
  return (
    <div id="construction-management-virtual-design" className="mt-10 w-full rounded-3xl bg-neutral-50/60 p-6">
      <div className="w-full">
        <div className="mx-auto flex w-[98%] max-w-[85rem] flex-col gap-6 lg:flex-row lg:items-stretch lg:justify-center">
          ...
          {cardShell('bim', 'BIM Coordination', {
            ...
            paragraph: (
              <p className="absolute inset-x-4 top-[6.75rem] max-h-0 overflow-hidden text-pretty opacity-0 transition-[max-height,opacity,transform] duration-300 ease-out [transition-delay:0ms] max-lg:group-data-[expanded=true]:max-h-[13rem] max-lg:group-data-[expanded=true]:translate-y-0 max-lg:group-data-[expanded=true]:opacity-100 max-lg:group-data-[expanded=true]:[transition-delay:380ms] lg:inset-x-8 lg:top-[7.5rem] lg:group-hover:max-h-[15rem] lg:group-hover:translate-y-0 lg:group-hover:opacity-100 lg:group-hover:[transition-delay:380ms] text-[0.6875rem] leading-snug text-white/95 lg:text-xs lg:leading-snug translate-y-2">
