...
export default function FooterFacebookIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className={className} aria-hidden {...props}>
      <path
        fill="currentColor"
